...
export default function Summary() {
  ...
  const total = (bookings || 0) + (start || 0);

  if (isLoadingBookings || isLoadingStart) return <div>Ładowanie...</div>;
  if (isError || isStartError) return <div>Błąd ładowania danych</div>;
  return (
    <Card>
      <CardHeader>
